    ...
    <div className="flex items-center justify-between py-5 font-medium">
      ...
      <div className={`absolute top-0 right-0 bottom-0 transition-all bg-white ${visible ? 'w-full' : 'w-0'}`}>
          <div className="flex flex-col text-gray-500">
            ...
            <NavLink onClick={()=> setVisible(false)} className='py-2 pl-6 ' to='Home'>Home</NavLink>
            <NavLink onClick={()=> setVisible(false)} className='py-2 pl-6 ' to='collection'>Collections</NavLink>
            <NavLink onClick={()=> setVisible(false)} className='py-2 pl-6 ' to='about'>ABOUT</NavLink>
            <NavLink onClick={()=> setVisible(false)} className='py-2 pl-6 ' to='home'>CONTACT</NavLink>
          </div>
      </div>
    </div>
  );
